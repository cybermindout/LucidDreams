<%-- 
    ...
    Created on : 26 Jan, 2022, 3:40:16 PM
    Author     : asanj
--%>
...
<html>
    ...
    <body>
        ...
        <div id="tab">
        <form name="frmeditprofile" method="post" action="../Assets/Actionpages/LandlordProfileEditAction.jsp" enctype="multipart/form-data">
            <table border="1" align="center" cellpadding="10" style="border-collapse: collapse">
               <%
                ...
                <tr>
                    <td>Name</td>
                    <td><input type="text" name="txtfname" value="<%=rs.getString("landlord_name") %>"></td>
                                   
                </tr>
                
                <tr>
                   <td>Contact</td>
                   <td><input type="text" name="txtcontact" value="<%=rs.getString("landlord_contact") %>" pattern="[0-9]{10}"></td>
                </tr> 
                <tr>
                   <td>Date of Birth</td>
                    <td><input type="date" name="dob" value="<%=rs.getString("landlord_dob") %>" required></td>
                </tr>
                <tr>
                    <td>Address</td>
                    <td><textarea name="txtaddress"><%=rs.getString("landlord_address") %>
                        </textarea>
                    </td>
                </tr>
                <tr>
