...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_id,user_rating,user_review,review_datetime,worker_id)"
                + "VALUES('" + session.getAttribute("userid") + "','" + request.getParameter("rating_data") + "','" + request.getParameter("user_review") + "',SYSDATE(),'" + session.getAttribute("lid") + "')";
    ...
    if (request.getParameter("action") != null) {
        ...
        while (rs.next()) {
            ...
            a.put("user_id", rs.getString("user_id"));
