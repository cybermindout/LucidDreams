        ...
        <table>    
            ...
            {    
                ...
                <table>
                    ...
                    <p style="text-align:center;border:1px solid #999;margin:22px;padding:10px;align:center">
                        <a href="LatestWorkBooking.jsp?wid=<%=session.getAttribute("wid")%>">Book</a></p></td></tr>
