...
<html>
    ...
    <body>
        <%@include file="Head.jsp" %>
         <br><br><br><br><br><br>
        <h1 align="center">View Work Bookings</h1>
        ...
        <table border="1" align="center" cellpadding="10">
            ...
            <%
            String s="select * from tbl_lworkbooking lb inner join tbl_latestwork l on lb.worker_id=l.worker_id inner join tbl_worker w on w.worker_id=l.worker_id inner join tbl_user u on lb.user_id=u.user_id where u.user_id='"+session.getAttribute("userid")+"'";
            ...
            <tr>
                <td><%=i%></td>
                <td><img src="../Assets/Worker/<%=r.getString("worker_photo")%>" width="100" height="100"></td>
