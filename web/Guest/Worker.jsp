 <%-- 
    Document   : Worker
    Created on : 25 Jan, 2022, 12:33:03 PM
    Author     : asanj
--%>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-info">
                                ...
                                <img src="../Assets/Template/Main/images/worker.png" style="margin-left:80px;margin-top:250px" width="300" height="250"/>

                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="contact-form">
            <form name="frmworker" method="post" action="../Assets/Actionpages/WorkerUploadAction.jsp" enctype="multipart/form-data">
            <table border="1" align="center" cellpadding="10" style="border-collapse: collapse">
                <div class="control-group">
                
           <input type="text" name="txtname" class="form-control" placeholder="Enter Your Name" value="" required onchange="nameval(this)">
                    <div id="name"></div>
                </div>
                <br>
             <div class="control-group">
                  ...
                  <div class="control-group">
                        ...
                        <select class="form-control" style="background-color:transparent" name="workertype" required="">
                            <option value="" selected="" style="text-align: center">--Select Work Type--</option>
                            <%
            ...
            %>
                            <option value="<%=r.getString("workertype_id")%>"><%=r.getString("workertype_name") %></option>
                            <%
                    }
            %>
                        </select>    
                        ...
                        <br>
                        <div class="control-group">
                            <input type="text" name="txtcontact" class="form-control" placeholder="Enter Valid Phone Number" value="" pattern="[0-9]{10}" required onchange="checknum(this)">
                   <div id="contact"></div>
                        </div>
                        <br>
               <div class="control-group">
                    <input type="email" class="form-control" placeholder="Your Email" name="email" value="" required onchange="emailval(this),checkEmail(this.value)">
                    <div id="content"></div>
               </div><br>
                     <div class="control-group">
               ...
               <br>
                <div class="control-group">
                    ...
                    <select name="district" required="" class="form-control" style="background-color:transparent" onchange="getPlace(this.value)">
            ...
            <div class="control-group">
                <select name="place" id="place" required="" class="form-control" style="background-color:transparent">
                    <option value="" selected="" style="text-align: center">--Select Place--</option>
                          
                        </select>    
            </div><br>
         <div class="control-group">
             <textarea name="txtaddress" required="" class="form-control" placeholder="Address" required data-validation-required-message="Please enter your Address"></textarea>
            ...
            <div class="control-group">
              ...
              <div class="control-group">
               ...
               <div class="control-group">
                   <input type="password" placeholder="Your Password" class="form-control" name="txtpwd" value="" required>
               </div><br>
                <div class="control-group">
                    <input type="password" name="txtpwd1" class="form-control" placeholder="Re ENter Password" value="" required onchange="chkpwd(this,txtpwd)">
               <div id="pass"></div></div>
               <br>
               <div align="center">
