                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-info">
                                ...
                                <img src="../Assets/Template/Main/images/user.png" style="margin-left:80px;margin-top:250px" width="300" height="250"/>
                 ...
                 <select name="place" id="location" required="" class="form-control" style="background-color: transparent">
                     <option value="" selected="" style="text-align: center">--Select Location--</option>
                      ...
                      <div class="control-group">
                          ...
                          <div class="control-group"><input type="password" class="form-control" name="txtpwd" value="" required plce holder="Password"></div><br>
