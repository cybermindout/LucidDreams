...
.btn:hover {opacity: 1}
    ...
    <body>
         ...
         <h1 align="center">Search Lands</h1>
         <div id="tab">
        <form name="frmsearch" method="post">
            ...
            <div id="result">
                        <table align="center">
                            ...
                            <tr>
                                <%
                                String sel="select * from tbl_land la inner join tbl_location l on la.location_id=l.location_id inner join tbl_place p on p.place_id=l.place_id inner join tbl_district d on d.district_id=p.district_id inner join tbl_landlord lr on la.landlord_id=lr.landlord_id where landlord_vstatus=1 ";
                            ...
                            <td class="zoom"><p style="text-align:center;border:1px solid #999;margin:22px;padding:10px"><img src="../Assets/Land/<%=rw.getString("land_image")%>" width="100" height="100"><br>
                                    ...
                                    Area:<%=rw.getString("land_area")%><br>
                                    Rate per cent:<%=rw.getString("land_centrate")%><br>
                                    Address:<%=rw.getString("land_address")%><br>
                                    Details:<%=rw.getString("land_details")%><br>
