        ...
        <form method="post">
            ...
            <%                String sel = "select * from tbl_carthead b inner join tbl_cartbody c on c.cart_id=b.cart_id where b.user_id='" + session.getAttribute("userid") + "' and booking_status='0'";
                ...
                while (rs.next()) {
                    ...
                    if (rsprd.next()) {
                        String selprdStock1 = "select * from tbl_sproductstock where sproduct_id='" + rsprd.getString("sproduct_id") + "'";
                        ResultSet rsprdStock1 = con.selectCommand(selprdStock1);
                        rsprdStock1.next();
            ...
            <div class="product">
                ...
                <div class="product-price"><%=rsprdStock1.getString("sproduct_rate")%></div>
                ...
                <div class="product-line-price">
                    <%
                        float pr = Float.parseFloat(rsprdStock1.getString("sproduct_rate"));
