...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
     ...
     <nav  class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
          <a class="navbar-brand" href="Homepage.jsp" style="color:black">LUCID DREAMS</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="Homepage.jsp" style="color:black">Home</a></li>
							<li class="nav-item submenu dropdown" style="color:black">
							
							<li class="nav-item"><a class="nav-link" href="MyProfile.jsp" style="color:black">My Profile</a></li>
                                                        <li class="nav-item"><a class="nav-link" href="Land.jsp" style="color:black">Land</a></li>
                                                        <li class="nav-item"><a class="nav-link" href="BookingReport.jsp" style="color:black">Booking Report</a></li>
                                                       <li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false"  style="color:black">Booking</a>
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="ViewRejectedtedLandBookings.jsp" style="color:black">Rejected</a></li>
                                                        ...
                                                        <li class="nav-item"><a class="nav-link" href="ViewUserBookings.jsp" style="color:black">Bookings</a></li>
						</ul>
