                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="media d-block mb-4 text-center ftco-media p-md-5 p-4 ftco-animate">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mb-0"><a href="Login.jsp" class="btn btn-primary btn-sm">Find More</a></p>
                            </div>
                        </div>
                    </div>
                </div>          
  ...
  <!--<section class="ftco-section bg-light ftco-slant ftco-slant-white" id="section-counter">-->
        ...
        <div class="row mb-5">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Contributors</h2>
            <div class="row justify-content-center mb-5">
              <div class="col-md-7">
                <p class="lead">Work with us <a href="#">Team Lucid Dreams</a></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row no-gutters align-items-center ftco-animate">
          <div class="col-md-6 mb-md-0 mb-5">
              <img src="../Assets/Template/Main/images/worker.png" alt="Free Template by Free-Template.co" class="img-fluid">
          </div>
          <div class="col-md-6 p-md-5">
            <h3 class="h3 mb-4">Work with us as builder or worker</h3>
            <p>You can work with our organisation to more register with us </p>
            <p class="mb-5"><a href="Worker.jsp">Register</a></p>
          </div>
        </div>
        <div class="row no-gutters align-items-center ftco-animate">
          <div class="col-md-6 order-md-3 mb-md-0 mb-5">
              <img src="../Assets/Template/Main/images/home.png" alt="Free Template by Free-Template.co" class="img-fluid">
          </div>
          <div class="col-md-6 p-md-5 order-md-1">
            <h3 class="h3 mb-4">Work with us as a landlord</h3>
            <p>You can work with as a landlord in our organisation to more register with us</p>
            <p class="mb-5"><a href="Landlord.jsp">Register</a></p>
          </div>
        </div>
