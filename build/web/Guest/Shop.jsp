<%-- 
    Document   : Shop
    Created on : 10 Mar, 2022, 9:21:18 PM
    Author     : asanj
--%>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-info">
                                ...
                                <img src="../Assets/Template/Main/images/shop1.png" style="margin-left:80px;margin-top:250px" width="300" height="250"/>

                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="contact-form">
        <form name="frmnewshop" method="post" action="../Assets/Actionpages/ShopUploadAction.jsp" enctype="multipart/form-data">
            
                <div class="control-group"><input type="text" class="form-control" placeholder="Enter Name" name="txtname" value="" required autocomplete="off" onchange="nameval(this)">
                        <div id="name"></div>
                   </div><br>
                   ...
                   <div class="control-group"><input type="text" class="form-control" placeholder="Enter Valid Phone Number" name="txtcontact" value="" pattern="[0-9]{10}" required onchange="checknum(this)">
                      <div id="contact"></div></div><br>
                      
                      <div class="control-group"><input type="email" class="form-control" placeholder="Enter Mail" name="email" value="" required onkeyup="emailval(this),checkEmail(this.value)">
               ...
               <div class="control-group">
                   <select name="place" class="form-control" id="place" style="background-color: transparent" required onchange="getLocation(this.value)">
               ...
               <div class="control-group"><textarea name="txtaddress" required="" class="form-control" placeholder="Address" required data-validation-required-message="Please enter your Address" ></textarea>
                 ...
                 <div class="control-group">
                          <label id="txt_label" style="color: white">Select Your Photo</label>
                          <input type="file" class="form-control" name="proof"  required></div><br>
                
                          <div class="control-group"><input type="password" class="form-control" placeholder="Enter Password" name="txtpwd" value="" required>
               </div><br>
