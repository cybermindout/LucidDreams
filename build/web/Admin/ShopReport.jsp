        ...
        <form method="post">
            ...
            <table border="1" cellpadding="10" align="center">
                ...
                <%
                    ...
                    String sel="select * from tbl_shop where shop_doj>='"+request.getParameter("fdate")+"'";
                    ...
                    while(rs.next()){
                        ...
                        <tr>
                            ...
                            <td><img src="../Assets/Shop/<%=rs.getString("shop_logo")%>" width="75" height="75"></td>
                    ...
                    String sel="select * from tbl_shop where shop_doj<='"+request.getParameter("tdate")+"'";
                    ResultSet rs=con.selectCommand(sel);
                    int i=0;
                    while(rs.next()){
                        i++;
                    ...
                    String sel="select * from tbl_shop where shop_doj between '"+request.getParameter("fdate")+"' and '"+request.getParameter("tdate")+"'";
                    ResultSet rs=con.selectCommand(sel);
                    int i=0;
                    while(rs.next()){
                        i++;
